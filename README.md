...
- [🛠️ 기술 스택](#️-기술-스택-spring-backend)
- [📐 아키텍처](#-아키텍처)
- [🚀 CI/CD 파이프라인](#-cicd-파이프라인)
- [✨ 주요 기능](#-주요-기능)
- [🔐 인증 및 인가 플로우](#-인증-및-인가-플로우)
- [📊 ERD](#-erd)
- [⚙️ 기술적 노력 & 설계 고민](#️-기술적-노력--설계-고민)
- [🧪 Test Coverage (Jacoco)](#-test-coverage-jacoco)
- [📂 폴더 구조](#-폴더-구조)
- [🔃 협업 룰, 컨벤션, 브랜치 전략](#-협업-룰-컨벤션-브랜치-전략-rule-convention-git-branch-strategy)
- [👥 BOOST 팀원 소개](#-boost-팀원-소개)
...
- **비동기로 처리한 이유**
    ...
    - 그래서 DB 트랜잭션과 전송 로직을 분리하여 **사용자 응답 속도 향상 및 안정성 확보를 목적으로 비동기로 분리하였습니다.**
- **결과**
