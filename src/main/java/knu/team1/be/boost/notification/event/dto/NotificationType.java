...
public enum NotificationType {
    ...
    public String message(String taskTitle, String commenterName, String commentContent) {
        return String.format(messageFormat, taskTitle, commenterName, commentContent);
    }
}
